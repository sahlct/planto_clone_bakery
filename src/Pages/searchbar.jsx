...
export function SearchBar() {
    return (
        <div className='md:mb-10 mb-0 h-[100px] bg-[#f3fff3] w-full flex justify-center items-center space-x-2 md:px-4 px-0'>
            <div className='border-2 border-yellow-500 w-[40px] h-[40px] flex justify-center items-center rounded-md'>
            ...
            <div className='relative w-1/2'>
                <input
                    ...
                    className='w-full h-[40px] px-4 rounded-md border-2 border-yellow-500 focus:outline-none focus:border-yellow-600 transition-colors'
                />
            </div>
            <div className='border-2 border-yellow-500 w-[40px] h-[40px] flex justify-center items-center rounded-md'>
