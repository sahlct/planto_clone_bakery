    ...
    return (
        <>
            <div className='h-[300px] md:my-20 my-10 md:mx-20 mx-5 flex flex-col sm:flex-row sm:gap-0 gap-5 font-dm'>
                <div
                    className="md:h-[300px] w-full sm:w-3/4 md:px-10 px-2 py-2 md:py-0 flex flex-col gap-8 justify-center"
                    style={{
                        backgroundImage: "url('/assets/card_2.jpg')",
                ...
                >
                    ...
                    <div className='flex flex-col gap-1 px-2 md:px-0 text-white text-sm sm:text-base'>
